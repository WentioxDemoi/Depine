...
export default function Header() {
  ...
  return (
    <header
      id="header"
      className="fixed top-0 left-0 w-full flex items-center justify-between bg-black z-50 md:px-5"
    >
      <Link href={"/"}>
        <Image
          src="/images/logo.png"
      ...
      <div className="relative md:hidden p-5">
        ...
        {isDropdownOpen && (
          <div
            className={`fixed top-0 right-0 bg-white shadow-lg h-screen z-50 transition-transform duration-300 transform ${
              isDropdownOpen ? "translate-x-0" : "translate-x-full"
            } w-3/4 rounded-l-lg flex flex-col`}
          >
